...
-- Note: SET GLOBAL event_scheduler = ON; is not needed on managed MySQL (Aiven) — it's enabled by default.
-- On local MySQL, run it manually if needed: SET GLOBAL event_scheduler = ON;
